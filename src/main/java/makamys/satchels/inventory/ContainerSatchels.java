...
public class ContainerSatchels extends ContainerPlayer {
	...
	public void redoSlots(boolean enable) {
		int originalSlotCount = 45;
		System.out.println("redoSlots " + enable);
		inventorySlots.retainAll(inventorySlots.subList(0, originalSlotCount));
		inventoryItemStacks.retainAll(inventoryItemStacks.subList(0, originalSlotCount));
		originalSlotPositions.retainAll(originalSlotPositions.subList(0, originalSlotCount));
